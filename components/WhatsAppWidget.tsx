...
export default function WhatsAppWidget() {
  ...
  return (
    <a
      ...
      aria-label="Chat with Crestbourne on WhatsApp"
      title="Chat on WhatsApp"
      className={[
        "fixed right-5 z-[55] flex h-14 w-14 items-center justify-center",
        "rounded-full bg-[#25D366] text-white",
        "shadow-[0_4px_20px_rgba(37,211,102,0.45),0_2px_8px_rgba(23,22,18,0.12)]",
        "transition-[transform,box-shadow] duration-200",
        "hover:scale-105 hover:shadow-[0_6px_28px_rgba(37,211,102,0.5),0_4px_12px_rgba(23,22,18,0.15)]",
